          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-4 mb-8">
              {[
                ...
                { label: 'Active Emergencies', value: activeEmergencies.length, sub: 'Right now in your area' },
              ].map((stat) => (
            ...
            <div className="bg-white/[0.02] border border-white/[0.06] rounded-2xl p-6">
              ...
              {responders.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-white/10 text-xs">Share org code <span className="text-[#cc0000] font-mono">{org?.orgCode}</span></p>
                </div>
              ) : (
          ...
          <div>
            ...
            {emergencies.length === 0 ? (
              <div className="bg-white/[0.02] border border-white/[0.06] rounded-2xl p-16 text-center">
                ...
                <p className="text-white/10 text-xs mt-2">Your verified responders will be alerted automatically when emergencies occur</p>
              </div>
            ) : (
          ...
          <div>
            <div className="mb-8">
              ...
              <p className="text-white/30 text-sm">
                Share org code{' '}
                <span className="text-[#cc0000] font-mono font-bold">{org?.orgCode}</span>
                {' '}with your team to join. Click any staff to view full details.
              </p>
            </div>
